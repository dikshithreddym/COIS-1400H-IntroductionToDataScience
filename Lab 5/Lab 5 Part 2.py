...
for x in range(height):
    for y in range(width):
        # Assuming pixel values are normalized between 0 and 1
        # If pixel values are in the range 0 to 255, use `255 - greyscale_image[x, y, 0]`
        greyscale_image[x, y, :3] = 1 - greyscale_image[x, y, :3]

# Display the inverted greyscale image
plt.imshow(greyscale_image, cmap='gray')
plt.axis('off')  # Turn off axis numbers and ticks
plt.show()

# Save the inverted greyscale image to the specified path
output_path = "C:/Users/diksh/Desktop/COIS 1400H/Lab5/flower_inverted_greyscale.png"
